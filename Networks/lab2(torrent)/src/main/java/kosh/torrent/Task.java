...
public class Task {
    ...
    //saveBlock
    private Task(TaskType type, int idx, int begin, byte[] blockData, Peer who) {
        this.type = type;
        this.who = who;
    ...
    * @return new extract block task
     ...
     */
    public static Task createSaveTask(int idx, int begin, byte[] data, Peer who) {
        return new Task(TaskType.SAVE, idx, begin, data, who);
    }
